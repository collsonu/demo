...
const Header = () => {
  return (
    <>
      ...
      <header className="bg-gray-500 top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64  from-blue-500 via-purple-500 sticky to-pink-500 p-2">
        <div className="hidden md:flex justify-between items-center py-1 border-b text-sm"
      ...
      {/* <nav classNameName="bg-gradient-to-r from-blue-500 via-purple-500 sticky top-0 z-50 to-pink-500 p-2">
        <div classNameName="container mx-auto flex justify-between items-center">
          <div classNameName="text-white font-extrabold text-2xl">Your Logo</div>
          <ul classNameName="flex space-x-4">
            <li classNameName="text-white hover:text-gray-300 transition duration-300 cursor-pointer">
              <NavLink
              to= '/'
